    ...
    private void processMouseEvents(MouseEvent e) {
        ...
        if (icon != null) {
            ...
            Rectangle drawRect = new Rectangle(
                    rect.x - pos.x + USBscope50_Main.SlitPaneEffect, rect.y - pos.y, rect.width + 5, rect.height + 5);
            ...
            if (e.getID() == e.MOUSE_PRESSED) {
                ...
                pos.x += e.getX();//X();
                pos.x = pos.x - USBscope50_Main.SlitPaneEffect;
                pos.y += e.getY();
    ...
    class CloseTabIcon implements Icon {
        ...
        public void paintIcon(Component c, Graphics g, int x, int y) {
            ...
            try {
                ...
                tabNumber = tabbedpane.getUI().tabForCoordinate(tabbedpane, (x + USBscope50_Main.SlitPaneEffect), y);
                JComponent curPanel = (JComponent) tabbedpane.getComponentAt(tabNumber);
                tabTitle = tabbedpane.getTitleAt(tabNumber);
                Object prop = null;
            ...
            if (doPaintCloseIcon) {
                ...
                if (normalCloseIcon != null && !mouseover) {
                    ...
                    if (mouseover) {
                        if (tabTitle.contains("Ch 1")) {
                            g.setColor(USBscope50_Main.ColorCh1);
                        } else if (tabTitle.contains("Ch 2")) {
                            g.setColor(USBscope50_Main.ColorCh2);
                        } else if (tabTitle.contains("Ch 3")) {
                            g.setColor(USBscope50_Main.ColorCh3);
                        } else if (tabTitle.contains("Ch 4")) {
                            g.setColor(USBscope50_Main.ColorCh4);
                        } else {
                    ...
                    //next 5 lines draw a sqaure around X on the tab
